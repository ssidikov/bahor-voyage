...
export async function syncTourPackages() {
  await checkAdmin();

  // Ensure the 4 main packages exist in the DB
  const packages = [
    {
      slug: 'samarcande-boukhara',
      titleFr: 'Samarcande & Boukhara',
      titleEn: 'Samarkand & Bukhara',
      durationDays: 7,
    },
    {
      slug: 'voyage-solidaire-11j',
      titleFr: 'Voyage Solidaire',
      titleEn: 'Solidarity Tour',
      durationDays: 11,
    },
    {
