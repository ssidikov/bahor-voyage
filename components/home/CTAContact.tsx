...
export function CTAContact() {
  ...
  return (
    <section className="relative min-h-[60vh] overflow-hidden flex items-center justify-center">
      {/* Background image — subtle zoom on enter */}
      <motion.div
        initial={{ scale: 1.06 }}
        whileInView={{ scale: 1 }}
        viewport={{ once: true }}
      ...
      {/* Content */}
      <div className="relative z-10 text-center px-6 md:px-10 py-20 md:py-28 w-full">
        <motion.div
        ...
        >
          <motion.p
            variants={fadeUp}
            className="text-label uppercase tracking-[0.15em] text-white/60 mb-4"
          >
            Bahor-Voyage
          </motion.p>
          ...
          <motion.h2
            variants={fadeUp}
            className="font-serif text-display-xl text-white font-light max-w-[75rem] mx-auto"
          >
            {t('cta_title')}
          </motion.h2>

          <motion.div variants={fadeUp} className="divider-gold-center my-8" />
          ...
          >
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-3 bg-white/15 border border-white/30 text-white backdrop-blur-sm rounded-pill px-8 py-3.5 font-medium transition-all duration-300 hover:bg-white hover:text-primary-600"
            >
              <svg
                viewBox="0 0 24 24"
                fill="none"
