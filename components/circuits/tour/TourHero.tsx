...
export default function TourHero({
  ...
  return (
    <section className="relative bg-[#fafafa] pt-20 md:pt-22 pb-6">
      <div className="mx-2 rounded-3xl overflow-hidden relative h-[82vh] min-h-155">
        {/* Parallax background */}
        <motion.div
        ...
        <div className="absolute inset-0 bg-linear-to-r from-charcoal-900/30 to-transparent" />

        {/* Content */}
        <div className="absolute inset-x-0 bottom-0 z-10 pb-8 flex flex-col justify-end">
          <div className="w-full max-w-content mx-auto px-8 md:px-12 min-w-0 overflow-hidden">
            {/* Tag + duration pill */}
            <motion.div
