...
export const samarkandBoukhara: TourData = {
  ...
  practicals: [
    {
      key: 'samarkand_boukhara_practical_visa',
      icon: (
        <svg
          width="28"
          height="28"
    ...
    {
      key: 'samarkand_boukhara_practical_flight',
      icon: (
        <svg
          width="28"
          height="28"
    ...
    {
      key: 'samarkand_boukhara_practical_season',
      icon: (
        <svg
          width="28"
          height="28"
    ...
    {
      key: 'samarkand_boukhara_practical_currency',
      icon: (
        <svg
          width="28"
          height="28"
