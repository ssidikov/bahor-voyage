...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      description,
      url: isFr
        ? 'https://www.bahorvoyage.com/circuits/voyage-solidaire-11j'
        : 'https://www.bahorvoyage.com/en/circuits/voyage-solidaire-11j',
      ...
      images: [
        {
          url: 'https://cdn.bahorvoyage.com/images/tours/Bukhara-Old-Sity.jpg',
          width: 1200,
          height: 630,
          alt: isFr
    ...
    twitter: {
      ...
      title,
      description,
      images: ['https://cdn.bahorvoyage.com/images/tours/Bukhara-Old-Sity.jpg'],
    },
  };
}
