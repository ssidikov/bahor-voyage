...
A knowledge graph of this codebase is available at `graphify-out/GRAPH_REPORT.md`.
Before answering any architecture or SEO questions, read this file first.
...
- For bugs, reproduce first and verify fix.
